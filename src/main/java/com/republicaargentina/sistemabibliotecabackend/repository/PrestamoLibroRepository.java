...
public interface PrestamoLibroRepository extends JpaRepository<PrestamoLibro, Long> {
        ...
        Page<PrestamoLibro> paginationByFechaPrestamo(LocalDateTime fechaPrestamoStart, LocalDateTime fechaPrestamoEnd,
                        Pageable pageable);
        ...
        @Query("""
                        ...
                        order by p.fechaPrestamo DESC""")
        Page<PrestamoLibro> paginationByFechaPrestamoAndDocente(LocalDateTime fechaPrestamoStart,
        ...
        @Query("""
                        ...
                        order by p.fechaPrestamo DESC""")
        Page<PrestamoLibro> paginationByFechaPrestamoAndGradoAndSeccion(LocalDateTime fechaPrestamoStart,
        ...
        @Query("""
                        ...
                        order by p.fechaPrestamo DESC""")
        Page<PrestamoLibro> paginationByFechaPrestamoAndDescripcion(LocalDateTime fechaPrestamoStart,
