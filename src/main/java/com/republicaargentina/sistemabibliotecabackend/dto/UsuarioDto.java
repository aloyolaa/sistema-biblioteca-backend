...
/**
 * DTO for
 * {@link com.republicaargentina.sistemabibliotecabackend.entity.Usuario}
 */
public record UsuarioDto(Long id,
        @Size(min = 4, message = "{Size.usuario.username}") @NotBlank(message = "{NotBlank.usuario.username}") String username,
        @Email @NotBlank(message = "{NotBlank.usuario.email}") String email,
        @NotBlank(message = "{NotBlank.usuario.nombres}") String nombres,
